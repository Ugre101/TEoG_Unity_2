...
public class ForcedGetFuckedAnal : LoseScene
{
    ...
    {
        string returnText = "Your enemy forces your beaten body to its hands and knees; you can't even muster the energy to collapse. ";
        ...
        if (player.Gender == Genders.Herm && player.SexualOrgans.HaveBalls())
        {
        ...
        else if (player.SexualOrgans.HaveBalls())
        {
