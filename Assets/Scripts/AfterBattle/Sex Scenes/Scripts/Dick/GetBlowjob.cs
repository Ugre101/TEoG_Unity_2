...
;
    ...
    public override string ContinueScene(PlayerMain player, BasicChar other)
    {
        ...
        if (player.SexualOrgans.Balls.Biggest() > 5)
        {
            return $"Continuing to thrust, your {Settings.MorInch(player.SexualOrgans.Balls.Biggest())} balls slap repeatedly against your foe, causing them to grunt in annoyance. Your thrusting continues as you make proper use of your opponent’ s mouth. You grab your foe 's forearm and guide it to your sac, grunting in demand as they start to fondle you.";
        }
