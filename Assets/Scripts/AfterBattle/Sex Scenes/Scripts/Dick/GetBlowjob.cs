...
public class GetBlowjob : SexScenes
{
    ...
    {
        string dickSize = Settings.MorInch(player.SexualOrgans.Dicks.BiggestSize());
...
;
    ...
    public override string ContinueScene(PlayerMain player, BasicChar other)
    {
        ...
        if (player.SexualOrgans.Balls.BiggestSize() > 5)
        {
            string dickSize = Settings.MorInch(player.SexualOrgans.Balls.BiggestSize());
