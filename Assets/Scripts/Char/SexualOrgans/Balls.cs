...
public static class BallsExtensions
{
    ...
    public static float Cumming(this IEnumerable<Balls> balls) => balls.Sum(b => b.Fluid.DisCharge());

    public static float Cumming(this IEnumerable<Balls> balls, float dischargePrecentage) => balls.Sum(b => b.Fluid.DisCharge(dischargePrecentage));
